      ...
      <div className={`${navbarBg} ${flexBetween} fixed top-0 z-30 w-full py-6`}>
        <div className={`${flexBetween} mx-auto w-5/6`}>
          <div className={`${flexBetween} w-full gap-16`}>
            <h1 className="font-bold text-4xl text-black">Atletech</h1>
            ...
            <div className={`${flexBetween} w-full`}>
              ...
              <div className={`${flexBetween} gap-8`}>
               ...
               : (
                <button className="rounded-full bg-secondary-400 p-2" onClick={() => setIsMenuToggled(!isMenuToggled)}><Bars3Icon className="h-6 w-6 text-white"/></button>
              )}
          </div>
        </div>
      </div>
